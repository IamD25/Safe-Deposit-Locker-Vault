...
$time = time();
$td = (date("Y-m-d", $time));
$dataFatchQur = "SELECT * FROM `inouttransaction` WHERE `date` = '$td'";
$dataFatchRes = mysqli_query($con, $dataFatchQur);
$fatcNum = mysqli_num_rows($dataFatchRes);
            ...
            <div id="lockers" class="col-md-10 ml-sm-auto px-4 content ">
                <div class="row">
                    <div class="col pt-3 pb-2">
                        <h1 class="h2">Today's Transaction</h1>
                    </div>
                ...
                <div class="table-responsive">
                    ...
                    <h5 class="text-center" id="notran">There is no Transaction Today..</h5>
                </div>
            </div>
