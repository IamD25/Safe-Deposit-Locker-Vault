...
$dataRequest = "SELECT * FROM `requests` Where `status` = 'Rejected'";
    ...
    <!-- <div class="b-example-divider"></div> -->
            ...
            <div id="requests" class="col-md-10 ml-sm-auto px-4 content ">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Reject User Requests</h1>
                        ...
                        <tbody id="lockerTableBody">
                            <?php while ($resRow = mysqli_fetch_assoc($resRequest)) { ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-warning" id="btndelete" href="requestPendingQ.php?id=<?= $resRow['request_id']; ?>">Pending</a></td>
